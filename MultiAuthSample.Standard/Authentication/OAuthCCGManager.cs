...
namespace MultiAuthSample.Standard.Authentication
{
    ...
    public class OAuthCCGManager : AuthManager, IOAuthCCGCredentials
    {
            ...
            Func<OAuthAuthorizationController> getOAuthController)
        {
            ...
            OAuthClockSkew = oAuthCCG?.OAuthClockSkew;
            OAuthTokenProvider = oAuthCCG?.OAuthTokenProvider;
            OAuthOnTokenUpdate = oAuthCCG?.OAuthOnTokenUpdate;
            OAuthTokenAutoRefresh = oAuthCCG?.OAuthToken;
        }
        ...
        /// </summary>
        public Func<OAuthCCGManager, OAuthToken, Task<OAuthToken>> OAuthTokenProvider { get; }
        ...
        {
            var token = await getOAuthController().RequestTokenOAuthCCGAsync(BuildBasicAuthHeader(), fieldParameters: additionalParameters).ConfigureAwait(false);
    ...
    public sealed class OAuthCCGModel
    {
        ...
        internal Func<OAuthCCGManager, OAuthToken, Task<OAuthToken>> OAuthTokenProvider { get; set; }
        ...
        public class Builder
        {
            ...
            private Func<OAuthCCGManager, OAuthToken, Task<OAuthToken>> oAuthTokenProvider;
            ...
            /// <returns>Builder.</returns>
            public Builder OAuthTokenProvider(Func<OAuthCCGManager, OAuthToken, Task<OAuthToken>> oAuthTokenProvider)
            {
        ...
        internal static OAuthCCGModel FromOptions(OAuthCCGModelOptions options)
        {
    ...
    public class OAuthCCGModelOptions
    {
