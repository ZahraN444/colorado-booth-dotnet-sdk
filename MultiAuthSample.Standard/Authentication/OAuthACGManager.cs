...
namespace MultiAuthSample.Standard.Authentication
{
    ...
    public class OAuthACGManager : AuthManager, IOAuthACGCredentials
    {
        ...
        {
            var token = await getOAuthController().RequestTokenOAuthACGAsync(BuildBasicAuthHeader(), authorizationCode, OAuthRedirectUri, additionalParameters).ConfigureAwait(false);
        ...
        {
            var token = await getOAuthController().RefreshTokenOAuthACGAsync(BuildBasicAuthHeader(), this.OAuthToken.RefreshToken, this.OAuthScopes.GetValues(), additionalParameters).ConfigureAwait(false);
            return token;
        }
    ...
    public sealed class OAuthACGModel
    {
        ...
        internal static OAuthACGModel FromOptions(OAuthACGModelOptions options)
        {
    ...
    public class OAuthACGModelOptions
    {
        public string OAuthClientId { get; set; }
        public string OAuthClientSecret { get; set; }
        public string OAuthRedirectUri { get; set; }
        public List<Models.OAuthScopeOAuthACGEnum> OAuthScopes { get; set; }
    }
}